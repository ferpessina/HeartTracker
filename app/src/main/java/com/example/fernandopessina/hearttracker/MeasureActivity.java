...
public class MeasureActivity extends Activity implements CvCameraViewListener2 {
    ...
    public Mat onCameraFrame(CvCameraViewFrame inputFrame) {
        ...
        switch (MeasureActivity.viewMode) {
            case MeasureActivity.VIEW_MODE_RGBA:
                // input frame has RGBA format
                break;

            case MeasureActivity.VIEW_MODE_HIST:
                Mat hist = new Mat();
            ...
            case MeasureActivity.VIEW_MODE_CANNY:
                List<Mat> planes = new ArrayList<>();
                Core.split(rgba,planes);
                gray = planes.get(0);
                grayInnerWindow = gray.submat(top, top + height, left, left + width);
                rgbaInnerWindow = rgba.submat(top, top + height, left, left + width);
                Imgproc.equalizeHist(grayInnerWindow, mIntermediateMat);
            ...
            case MeasureActivity.VIEW_MODE_SOBEL:
            ...
            case MeasureActivity.VIEW_MODE_SEPIA:
                rgbaInnerWindow = rgba.submat(top, top + height, left, left + width);
                Core.transform(rgbaInnerWindow, rgbaInnerWindow, mSepiaKernel);
                rgbaInnerWindow.release();
                break;

            case MeasureActivity.VIEW_MODE_ZOOM:
            ...
            case MeasureActivity.VIEW_MODE_PIXELIZE:
                rgbaInnerWindow = rgba.submat(top, top + height, left, left + width);
            ...
            case MeasureActivity.VIEW_MODE_POSTERIZE:
            /*
